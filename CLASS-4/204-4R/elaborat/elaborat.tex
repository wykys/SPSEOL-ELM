...
\newcommand{\uloha}{NÍZKOFREKVENČNÍ ZESILOVAČ S OZ}
\newcommand{\pcislo}{204-4R} 			% číslo protokolu
...
\newcommand{\datm}{4.3.} 				% datum měření
\newcommand{\dato}{24.4.} 				% datum odevzdání
