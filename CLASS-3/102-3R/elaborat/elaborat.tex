...
\newcommand{\uloha}{MĚŘENÍ OPERAČNÍHO ZESILOVAČE}
\newcommand{\pcislo}{102-3R} 			% číslo protokolu
...
\newcommand{\datm}{24.3.} 				% datum měření
\newcommand{\dato}{31.3.} 				% datum odevzdání
